            ...
            >
              ...
              <div className="flex items-center gap-2.5 px-3 py-2.5">
                ...
                <div className="min-w-0">
                  <p className="truncate text-[12px] leading-snug font-semibold text-slate-900">
                    {user?.name ?? "User"}
                  </p>
              ...
              <div className="p-1">
                <DropdownMenuItem
                  ...
                  className="flex cursor-pointer items-center gap-2 rounded-lg px-2.5 py-1.5 text-[12px] font-medium text-slate-500 transition-colors outline-none focus:bg-slate-50 focus:text-slate-700"
                >
                ...
                <DropdownMenuItem
                  onClick={logout}
                  className="flex cursor-pointer items-center gap-2 rounded-lg px-2.5 py-1.5 text-[12px] font-medium text-slate-500 transition-colors outline-none focus:bg-red-50 focus:text-red-500"
                >
